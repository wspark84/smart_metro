...
import { GYEONGGI_CITIES, normalizeGyeonggiCity } from '../logic/gyeonggi-cities.js';
export { GYEONGGI_CITIES } from '../logic/gyeonggi-cities.js';
...
export async function searchUnifiedBusStations({cityId,keyword},{loadCities=fetchUnifiedBusCities,search=searchLiveStations}={}) {
  ...
  results.forEach((result,index)=>{
    ...
    for(const station of result.value.stations || []) {
      ...
      if(provider==='gyeonggi' && normalizeGyeonggiCity(station.regionName)!==city.id.slice(3)) continue;
